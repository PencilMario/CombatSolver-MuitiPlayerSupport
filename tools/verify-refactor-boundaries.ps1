...
$beamStructureChecks = @(
    ...
    @{ File = "CombatBeamSolver.ParallelExpansion.cs"; Text = "private ExpansionWorkerOutcome[] EvaluateQueuedParents(" },
    @{ File = "CombatBeamSolver.ParallelExpansion.cs"; Text = "bool[] receivedOutcomes = new bool[nodes.Count];" },
    @{ File = "CombatBeamSolver.ParallelExpansion.cs"; Text = "public int WaitForNextOutcome()" },
    @{ File = "CombatBeamSolver.ParallelExpansion.cs"; Text = "_extraParentLane?.ResetRebuildableCaches();" },
